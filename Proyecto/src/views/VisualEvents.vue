...
onMounted(async () => {
  ...
  try {
    ...
    if (!response || !response.success || !response.event) {
      loadError.value = 'No se encontró el evento.'
      return
    }
        ...
        <template v-else>
          <div class="grid grid-cols-2 gap-2">
            <div>
              ...
              <input v-model="title" disabled class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 mb-2 opacity-70" />
            </div>
            <div>
              <label class="block mb-1 text-sm font-medium text-gray-700">Descripción</label>
              <input v-model="description" disabled class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 mb-2 opacity-70" />
            </div>
          </div>
          <div class="grid grid-cols-2 gap-2">
            <div>
              <label class="block mb-1 text-sm font-medium text-gray-700">Ubicación</label>
              <input v-model="localization" disabled class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 mb-2 opacity-70" />
            </div>
            <div>
              <label class="block mb-1 text-sm font-medium text-gray-700">Precio</label>
              <input v-model="price" disabled class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 mb-2 opacity-70" />
            </div>
          </div>
          <div class="grid grid-cols-2 gap-2">
            <div>
            ...
            <div>
              ...
              <input v-model="link" disabled class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 mb-2 opacity-70" />
            </div>
          </div>
        </template>
